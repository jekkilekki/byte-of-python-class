# python_text_game.py
'''A text-based RPG/fighting game.

This game was posted to stackexchange.com
https://codereview.stackexchange.com/questions/223917
/text-based-fighting-game-in-python-3-0
where the original author sought help to improve it.

Someone posted an answer that included Classes
for the 3 different character types, so it
will serve as an excellent example for my
Beginner Python class.

This will be our final project.
'''

# Game Requirements
'''Explanation of requirements.

1. Text input - for user choices, character name, etc.
2. Give choices - as a series of int values (1, 2, 3...)
3. Random outcomes - attacks, spells, heals do random
amounts of damage or restoration.
'''

# Python's random module for #3
import random as r
